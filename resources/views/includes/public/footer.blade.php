              ...
              <div class="row">
                  ...
                  <div class="col-md-4 col-xl-3 offset-xl-1">
                      <div class="footer-item d-flex flex-column text-white">
                          ...
                          <a href="{{url('/#tentang')}}"><i class="fas fa-angle-right me-2"></i> Tentang Kami</a>
                          <a href="{{url('/#paket-tryout')}}"><i class="fas fa-angle-right me-2"></i> Paket Tryout</a>
                          <a href="/kontak"><i class="fas fa-angle-right me-2"></i> Kontak</a>
                          <a href="/login"><i class="fas fa-angle-right me-2"></i> Login</a>
                          <a href="/register"><i class="fas fa-angle-right me-2"></i> Register</a>
                      </div>
                  </div>
