<!-- resources/views/emails/pengguna-status.blade.php -->
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <div class="container">
        <div class="header">
            <h1>Status Pendaftaran Akun</h1>
        </div>
        <div class="content">
            <p>Halo {{ $user->name }},</p>
            
            @if ($isApproved)
                <p>Selamat! Pendaftaran Anda sebagai pengguna pada platform kami telah <strong>disetujui</strong>.</p>
                
                <p>Anda sekarang dapat masuk ke panel pengguna dan mulai membuat kampanye penggalangan dana.</p>
            ...
            @else
                <p>Mohon maaf, pendaftaran Anda sebagai pengguna pada platform kami telah <strong>ditolak</strong>.</p>
